...
class WorkflowsClient {
    ...
    constructor(opts) {
        ...
        const createWorkflowResponse = protoFilesRoot.lookup('.google.cloud.workflows.v1.Workflow');
        const createWorkflowMetadata = protoFilesRoot.lookup('.google.cloud.workflows.v1.OperationMetadata');
        const deleteWorkflowResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteWorkflowMetadata = protoFilesRoot.lookup('.google.cloud.workflows.v1.OperationMetadata');
        const updateWorkflowResponse = protoFilesRoot.lookup('.google.cloud.workflows.v1.Workflow');
        const updateWorkflowMetadata = protoFilesRoot.lookup('.google.cloud.workflows.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.workflows.v1.Workflows', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.workflowsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.workflows.v1.Workflows')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.workflows.v1.Workflows, this._opts, this._providedCustomServicePath);
