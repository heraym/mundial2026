...
class WorkflowsClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listWorkflows: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'workflows'),
        };
        ...
        const createWorkflowResponse = protoFilesRoot.lookup('.google.cloud.workflows.v1beta.Workflow');
        const createWorkflowMetadata = protoFilesRoot.lookup('.google.cloud.workflows.v1beta.OperationMetadata');
        const deleteWorkflowResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteWorkflowMetadata = protoFilesRoot.lookup('.google.cloud.workflows.v1beta.OperationMetadata');
        const updateWorkflowResponse = protoFilesRoot.lookup('.google.cloud.workflows.v1beta.Workflow');
        const updateWorkflowMetadata = protoFilesRoot.lookup('.google.cloud.workflows.v1beta.OperationMetadata');
        this.descriptors.longrunning = {
            createWorkflow: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createWorkflowResponse.decode.bind(createWorkflowResponse), createWorkflowMetadata.decode.bind(createWorkflowMetadata)),
            deleteWorkflow: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteWorkflowResponse.decode.bind(deleteWorkflowResponse), deleteWorkflowMetadata.decode.bind(deleteWorkflowMetadata)),
            updateWorkflow: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateWorkflowResponse.decode.bind(updateWorkflowResponse), updateWorkflowMetadata.decode.bind(updateWorkflowMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.workflows.v1beta.Workflows', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.workflowsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.workflows.v1beta.Workflows')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.workflows.v1beta.Workflows, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of workflowsStubMethods) {
            const callPromise = this.workflowsStub.then((stub) => (...args) => {
                if (this._terminated) {
     ...
     */
    getWorkflow(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     */
    createWorkflow(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateWorkflowProgress(name) {
     ...
     * const [response] = await operation.promise();
     */
    deleteWorkflow(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     * console.log(decodedOperation.metadata);
     */
    async checkDeleteWorkflowProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     * const [response] = await operation.promise();
     */
    updateWorkflow(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     * console.log(decodedOperation.metadata);
     */
    async checkUpdateWorkflowProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     *   for more details and examples.
     */
    listWorkflows(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listWorkflowsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listWorkflows.createStream(this.innerApiCalls.listWorkflows, request, callSettings);
    }
    /**
    ...
    listWorkflowsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listWorkflows.asyncIterate(this.innerApiCalls['listWorkflows'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=workflows_client.js.map